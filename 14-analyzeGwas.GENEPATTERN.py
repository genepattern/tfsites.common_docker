...
helpMessage='''analyzeGwas.py finds all effects of SNVs from GWAS data.
...
def main(argv):
   ...
   tf.analyzeGwas(file, seq2aff, genome, iupac, zero_pos, mut, bed_list, outfile, upper_thresh, bottom_thresh)
